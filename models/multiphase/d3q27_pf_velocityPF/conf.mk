ADJOINT=0
TEST=FALSE
OPT="(PFSRT*PFMRT*q27*OutFlow  + BGK + thermo*planarBenchmark)*autosym*geometric*staircaseimp*isograd*tprec"
# PFMRT - MRT for phase field
# PFSRT - Using moment space for relaxation but all omega kept same
